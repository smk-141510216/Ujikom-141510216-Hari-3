            ...
            <div class="panel-body">
                ...
                <input name="_method" type="hidden" value="PATCH">
                    ...
                    <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="name" value="<?php echo e($data->User->name); ?>" autofocus required >
                    ...
                    <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="text" class="form-control" name="password" value="<?php echo e($data->User->password); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file" id="foto" class="form-control" name="foto" value="<?php echo e($data->foto); ?>" required>
