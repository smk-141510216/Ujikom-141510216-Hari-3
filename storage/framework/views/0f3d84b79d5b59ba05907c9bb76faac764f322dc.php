        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('lembur_pegawai.update',$lembur_pegawai->id)); ?>">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group <?php echo e($errors->has('jumlah_jam') ? 'has-errors':'message'); ?>" >
                                <input id="jumlah_jam" type="text" class="form-control" name="jumlah_jam" value="<?php echo e($lembur_pegawai->jumlah_jam); ?>" autofocus>
